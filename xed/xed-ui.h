...
static const GtkActionEntry xed_always_sensitive_menu_entries[] =
{
    ...
    { "FileRecentsMenu", NULL, N_("_Recents")},
...
static const GtkToggleActionEntry xed_always_sensitive_toggle_menu_entries[] =
{
	...
	{ "ViewMenubar", NULL, N_("_Menubar"), NULL,
	  N_("Show or hide the menubar in the current window"),
	  G_CALLBACK (_xed_cmd_view_show_menubar), TRUE },
